...
function k(a) {
    var c = ["#4c85e0", "#ba52dd", "#f45c2e", "#93648D", "#404040"],
        d = [-.1, -.05, 0];
    if (1 == a.depth) {
    ...
    if (a.depth > 1) {
        var f = d[a.value % 3];
        return d3.rgb(a.parent._color).brighter(.22 * a.depth + f * a.depth)
    }
}
var l;
var chart = function (d3) {
    ...
    var chart = {},
        ...
        i = [2011, 2012, 2013, 2014, 2015, 2016],
        ...
        bottomtick = d3
          ...
          .axis()
          .scale(j)
          .tickValues([2011, 2013, 2015, 2016])
